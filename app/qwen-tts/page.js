...
export default function Qwen3TTSPage() {
  ...
  const handleGenerate = async () => {
    ...
    try {
      ...
      const endpoint = refAudioFile ? '/api/clone' : '/api/tts';
      
      const response = await fetch(`${colabUrl}${endpoint}`, {
        method: 'POST',
        headers: { 
            ...
            <div className="mt-6 space-y-4">
              ...
              <div className="p-4 bg-purple-500/10 rounded-xl border border-purple-500/20">
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <a 
                      href="/qwen3_tts_colab_4.ipynb" 
                      download="qwen3_tts_colab_4.ipynb"
              ...
              <div className="p-4 bg-cyan-500/10 rounded-xl border border-cyan-500/20">
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    <p className="font-medium text-cyan-300 mb-2">Paste ngrok URL above & Connect!</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          {status === 'generating' && (
            <div className="space-y-2 animate-in fade-in bg-black/20 p-4 rounded-xl border border-white/5">
              ...
              <div className="h-3 bg-white/5 rounded-full overflow-hidden">
                <div className="h-full bg-linear-to-r from-purple-500 to-pink-500 rounded-full animate-pulse" style={{ width: '100%' }} />
              </div>
            </div>
          )}
